    ...
    <Layout className="home-shell">
      <Header className="home-header">
        <div className="home-header__inner">
          ...
          <nav className="home-nav" aria-label="工作台导览">
            <a href="#scheme-configuration">方案配置</a>
            <a href="#strategy-iteration">策略迭代</a>
            <a href="#simulation-showcase">推演展示</a>
          </nav>
        </div>
      </Header>
        ...
        <main className="home-main">
          <section className="home-hero" aria-labelledby="home-title">
            <div className="home-hero__copy">
              <Tag className="home-eyebrow">
                Strategy · Agent · Simulation
              </Tag>
              ...
              <Paragraph className="home-lead">
                基于上游平台规划好的推演方案、分支方案和策略，自动生成 tick-agent
                的执行时间窗、参与单位、目标与武器数量，并用仿真 report
                持续校准执行计划。
              </Paragraph>
            </div>

            <Card className="home-preview" bordered={false}>
            ...
            <div className="home-entry-grid">
              {entryCards.map((item) => (
                <a
                  ...
                  key={item.key}
                >
                  <Card className="home-entry__card" bordered={false}>
                    <div>
