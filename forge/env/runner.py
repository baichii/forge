...
from forge.utils.specs import EnvSpec, TickAgentSpec, CallbackSpec
...
class Runner(Protocol):
    ...
    Notes:
        1. 开发过程中发现通过配置参数，定义环境创建/连接的形式其实是很痛苦的，即使是最小测试场景下
    ...
    def __init__(self, env_spec: EnvSpec, tick_agents: list[TickAgent | TickAgentSpec], callbacks: CallBackList | list[CallbackSpec]) -> None:
